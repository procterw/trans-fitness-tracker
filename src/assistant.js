...
const DEFAULT_INGEST_CLASSIFIER_INSTRUCTIONS = [
  ...
  "The context may include recent_food_event_id for the most recently logged meal.",
  "When the user is correcting/refining that recent meal, set food.is_correction=true and set food.event_id=recent_food_event_id.",
  "When logging a new meal, set food.is_correction=false and set food.event_id=null.",
...
export async function decideIngestAction({
  ...
  const context = {
    ...
    recent_food_event_id:
      typeof recentFoodEventId === "string" && recentFoodEventId.trim() ? recentFoodEventId.trim() : null,
    has_image: hasImage,
